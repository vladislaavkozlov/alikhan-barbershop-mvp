...
// Екатерина дешевле Али/Мамедхана), ставка тоже по мастеру (/payroll-settings,
// master_payroll_settings: 100% у Али и Мамедхана, 40% по умолчанию у Екатерины,
...
async function renderLiveProof(staff) {
  ...
  try {
    ...
    // master-1/2/3 = порядок мастеров в /staff (Али/Мамедхан/Екатерина в макете -
