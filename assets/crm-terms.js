...
export const FALLBACK = Object.freeze({
  ...
  phrases: {
    ...
    "booking.cancelAction": "Отменить запись",
    "booking.cancelConfirm": "Отменить запись? Она останется в истории со статусом «отменена», время в расписании освободится",
    "booking.cancelDone": "Запись отменена",
    "booking.cancelFailed": "Не удалось отменить запись",
    "booking.cancelAlready": "Запись уже отменена",
