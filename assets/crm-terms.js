...
export const FALLBACK = Object.freeze({
  ...
  phrases: {
    ...
    "renew.noPhone": "Срок возврата у этой записи не спрашиваем - у клиента не указан телефон, напоминать некому. Впишите номер в поле «Телефон» выше, если хотите вести его историю и видеть его в «Недополученной выручке»",
    ...
    "team.acceptsOffHasBookings": "К «{name}» записаны люди: впереди записей {count}, ближайшая {when}. Снимете приём клиентов - строка пропадёт из расписания вместе с этими записями, а клиентов никто не предупредит. Сначала перенесите записи на другого сотрудника или отмените их",
    "team.acceptsOffShort": "Не сохранено: впереди записей {count}. Решите, что с ними делать",
    "team.acceptsOffCheckFailed": "Не удалось проверить будущие записи - связь с сервером подвела",
    "team.acceptsOffKeep": "Оставить приём клиентов",
    ...
    "analytics.renewDefaultNote": "Остальным поставлен месяц по умолчанию - это нормальный ответ мастера, но чем таких меньше, тем точнее «Недополученная выручка» в «Финансах»",
    ...
    "missed.repliedNoBooking": "ответил «да», но ещё не записался - звоните",
    "missed.rebooked": "записался сам на {date} - звонить не надо",
