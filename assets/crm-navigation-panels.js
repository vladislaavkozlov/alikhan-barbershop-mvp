...
export function upgradeMasterBookingPanel(root = document) {
  ...
  details.innerHTML = `<summary><div class="avatar-icon" aria-hidden="true"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"><rect x="3.5" y="5" width="17" height="15" rx="2.2"/><line x1="3.5" y1="9.5" x2="20.5" y2="9.5"/><path d="M8.5 14h7"/></svg></div><div class="summary-meta"><div class="name" data-term="booking.nom" data-term-cap>${Tc('booking.nom')}</div><div class="role" data-phrase="booking.detailsTitle">${P('booking.detailsTitle')}</div></div><span class="chevron">▸</span></summary>`;
  const body = document.createElement('div');
  body.className = 'staff-card-body';
  body.append(view);
  details.append(body);
...
export function upgradeBookingPanel(root = document) {
  ...
  details.innerHTML = `<summary><div class="avatar-icon" aria-hidden="true"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"><path d="M12 5v14M5 12h14"/></svg></div><div class="summary-meta"><div class="name" data-term="booking.nom" data-term-cap>${Tc('booking.nom')}</div><div class="role" data-phrase="booking.addToSchedule">${P('booking.addToSchedule')}</div></div><span class="chevron">▸</span></summary>`;
  const body = document.createElement('div');
  body.className = 'staff-card-body';
  body.append(form);
  details.append(body);
