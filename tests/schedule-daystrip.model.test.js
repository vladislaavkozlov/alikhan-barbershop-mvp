...
test('полоска: неделя на стыке месяцев называет оба месяца, в именительном падеже', () => {
  // 2026-08-31 (Пн) - 2026-09-06 (Вс). Падеж именно именительный (правка Влада
  // 21.08.2026): это заголовок периода, а не часть фразы про конкретную дату
  assert.equal(dayStripMonthLabel('2026-09-02'), 'Август-Сентябрь 2026');
  assert.equal(dayStripMonthLabel('2026-08-19'), 'Август 2026');
});
