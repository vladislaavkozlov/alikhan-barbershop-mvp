...
// База отсчёта на 24.08.2026, конец фазы 6: пусто. Барбершопных слов в исходниках
// кабинетов не осталось - 225 строк → 115 → 35 → 0. Теперь храповик работает в другую
// сторону: любое новое слово, написанное руками вместо словаря, роняет тест.
//
// 225, а не 424 из первого грубого замера: тот считал продолжения HTML-комментариев
// и строки импортов
const BASELINE = {
  // пусто: барбершопных слов в исходниках кабинетов не осталось
};
