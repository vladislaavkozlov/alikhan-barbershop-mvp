...
//
// Парная карточка к «Недополученной выручке»: та показывает, сколько денег утекло,
...
// недополученную выручку). Средний чек соврал бы в обе стороны, а цифра, на которой
...
export async function computeReturned(db, from, to) {
  ...
  // bookings.service_id, ровно как в зарплате и в недополученной выручки
