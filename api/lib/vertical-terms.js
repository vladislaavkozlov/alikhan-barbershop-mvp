...
export const PHRASES = {
  ...
  clinic: {
    ...
    'booking.cancelAction': 'Отменить приём',
    'booking.cancelConfirm': 'Отменить приём? Он останется в истории со статусом «отменён», время в расписании освободится',
    'booking.cancelDone': 'Приём отменён',
    'booking.cancelFailed': 'Не удалось отменить приём',
    'booking.cancelAlready': 'Приём уже отменён',
